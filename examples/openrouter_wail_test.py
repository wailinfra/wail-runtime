...
print("OpenRouter Baseline / Spike / Reroute")
print("=" * 70)
...
# CLIENT
# ==========================================================
SERVICE = "openrouter-controlled-infra-reroute-test"
ENV = "dev"
...
if not control_allowed and is_tech_artifact(execution_path):
    ...
    provider_valid = execution_metadata.get("provider") == "openrouter"
    initial_model_valid = execution_metadata.get("model") == PRIMARY_MODEL
    transport_valid = True
    target_consistency_valid = execution_target == {}
else:
    provider_valid = execution.get("initial_provider") == "openrouter"
    ...
    if execution_changed:
        transport_valid = (
            ...
            and execution_target.get("from_provider") == "openrouter"
            and execution_target.get("to_provider") == "openrouter"
        )
        ...
        transport_valid = (
            execution.get("initial_provider") == "openrouter"
            and execution.get("final_provider") == "openrouter"
        )
...
assert provider_valid, (
    ...
    f"expected=openrouter, actual={execution.get('initial_provider')}"
)
