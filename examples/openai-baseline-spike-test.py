...
print("OpenAI Baseline / Spike / Reroute")
print("=" * 70)
...
# CLIENT
# ==========================================================
SERVICE = "openai-controlled-infra-reroute-test"
ENV = "dev"
...
def run_stream(prompt, max_output_tokens, chunk_delay_seconds=0.0, model=PRIMARY_MODEL):
...
if not control_allowed and is_tech_artifact(execution_path):
    ...
    if execution_changed:
        transport_valid = (
            ...
            and execution_target.get("from_provider") == "openai"
            and execution_target.get("to_provider") == "openai"
        )
        ...
        transport_valid = (
            execution.get("initial_provider") == "openai"
            and execution.get("final_provider") == "openai"
        )
...
assert provider_valid, (
    ...
    f"expected=openai, actual={execution.get('initial_provider')}"
)
